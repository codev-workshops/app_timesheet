...
// Some Secrets Manager emulators answer errors with two `Date` headers. Node
// joins them into one unparsable value, the SDK's clock-skew correction then
// stores NaN as the system clock offset, and every later request fails to sign
// with "Invalid time value". Ignore non-finite offsets.
